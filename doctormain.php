   ...
   <script>
		...
		function showpreview(file,ref) 
		{
			...
			if($(file)[0].files[0].size>2097152)
				{
					alert("please put photos which is less than<=2 MB");
					return;
				}
	...
	$(document).ready(function()
        ...
        {
            var uid=$("#txtUid").val(); 
                $.getJSON("doctor-profile-json.php?uid="+uid,function(aryJson)//passing uid to fetch record
                {
                     if(aryJson.length==0)
                        {
                            alert("Sorry no details found,plz fill your details");
                  ...
                  //  alert(JSON.stringify(aryJson));
                     ...
                     $("#txtgen").val(aryJson[0].gender);
                       $("#txtcon").val(aryJson[0].consultation);
                     $("#txtadd").val(aryJson[0].addr);
                     $("#txtcont").val(aryJson[0].contact);
                     $("#txtstate").val(aryJson[0].	state);
                     $("#txtcity").val(aryJson[0].city);
                     $("#spec").val(aryJson[0].special);
...
<!--
            <div class="row">
                ...
                <div class="col-md-12  text-center text-white  bg-dark fixed-top">
                    <h2>DOCTOR PROFILE</h2> <div style="margin-right:10px "> </div>
                </div>
            </div>
-->
...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
 ...
 <div class="container" style="margin-top:10px" id="p">
                    ...
                    <div class="form-row">
                        <div class="col-md-6 offset-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" required class="form-control"  id="txtUid" name="txtUid" placeholder="Enter User Id" readonly value="<?php echo $_SESSION['uid'];?>">
        ...
        <!--------------------------------------------------------------->
                   <div class="form-row">
                    <div class="col-md-4">
                        <label for="txthname">HOSPITAL/CLINIC NAME</label>
                    ...
                    <label for="txtgen">GENDER</label>
                         ...
                         <div class="col-md-4">
                        <label for="txtcon">CONSULTATION FEE</label>
                        <input type="text" required class="form-control" id="txtcon" name="txtcon" placeholder="Enter your consultation fee">
                        <small id="errhname" class="form-text text-primary">*</small>
                    </div>  
        ...
        <!--------------------------------------------------------------->
                  <div class="form-row">
                    <div class="col-md-4">
                        <label for="txtcont">CONTACT NO</label>
             ...
             <div class="form-row">
                    ...
                    SPECIALIZATION
							<select name="spec" id="spec" class="form-control">
								...
								<option 
								value="Liver">LIVER</option>
								<option value="Stomach">STOMACH</option>
								<option value="Mental Wellness">MENTAL WELLNESS</option>
								<option value="Eye Care">EYE CARE</option>
								<option value="Piles,Fissures,Fistula">PILES,FISSURES,FISTULA</option>
    ...
    <!----------------------------------------------------------------->            <div class="col-mb-3 mt-100">YOUR DEGREE</div>
                  <div class="form-row">
                    ...
                    <div class="col-md-4 form-group text-center">
							 Pic1: <br>
							<img src="uploads/profilepic.png" class="mt-1 mb-1" width="150" height="150" alt="" id="pic1">
							<input type="file" accept="image/*" multiple name="ppic1" id="ppic1" onchange="showpreview(this,pic1);">

                       </div>
                       <div class="col-md-4 form-group text-center">
							 Pic2: <br>
							<img src="uploads/profilepic.png" class="mt-1 mb-1" width="150" height="150" alt="" id="pic2">
							<input type="file" accept="image/*" multiple name="ppic2" id="ppic2" onchange="showpreview(this,pic2);">

                       </div>
                       <div class="col-md-4 form-group text-center">
							 Pic3: <br>
							<img src="uploads/profilepic.png" class="mt-1 mb-1" width="150" height="150" alt="" id="pic3">
							<input type="file" accept="image/*" multiple name="ppic3" id="ppic3" onchange="showpreview(this,pic3);">
