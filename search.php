    ...
    <script>
		...
		module.controller("mycontroller", function($scope, $http) { 
            ...
            $scope.doFetchAll = function() {
				...
				$http.get("search-process.php?city="+city+"&state="+state+"&gender="+gender+"&time="+time).then(fine, notfine);
				...
				function notfine(response) {
					//alert(JSON.stringify(response));
                    alert("Sorry,there is no detail");
				}
			}
			//=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
            $scope.oneRecord;
			...
			{
				$http.get("doctor-profile-json.php?uid=" + uid).then(fine, notfine);
   ...
   <script>
        $(document).ready(function() {
            ...
            function loadState() {
                ...
                $.getJSON("json-fetch-state-doctor.php", function(jsonAry) {
            ...
            function loadcity() {
                ...
                $.getJSON("json-fetch-city-doctor.php", function(jsonAry) {
            ...
            function loadtime() {
                ...
                $.getJSON("json-fetch-time-doctor.php", function(jsonAry) {
    ...
    <nav class="navbar navbar-expand beta-menu navbar-dropdown align-items-center navbar-fixed-top navbar-toggleable-sm">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav nav-dropdown" data-app-modern-menu="true"><li class="nav-item">
                ...
                </li><li class="nav-item"><a class="nav-link link text-danger display-4" href="#">Sign Up&nbsp;</a></li></ul>
            <div class="navbar-buttons mbr-section-btn"><a class="btn btn-sm btn-secondary-outline display-7" href="#">Login</a></div>
        </div>
    </nav>
</section>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="media-container-column title col-12 col-md-10">
                <h2 class="align-left mbr-bold mbr-white pb-3 mbr-fonts-style display-2">LOOKING FOR A DOCTOR?</h2>
    ...
    <div class="container">
        <div class="media-container-row">
				...
				<div class="plan col-12 mx-2 my-2 justify-content-center col-lg-4" ng-repeat="oneObj in jsonAry ">
					...
					<img src="assets/images/{{oneObj.picname}}" class="card-img-top" width="150" height="150" alt="not availanme...">
					<div class="card-body">
						<h5 class="card-title plan-title mbr-fonts-style display-5">{{oneObj.name}}</h5>
						<p class="card-text mbr-fonts-style display-7"><span class="text-danger"> Hospital/Clinic Name:</span>{{oneObj.hName}}
						<br>
						<span class="text-danger mbr-fonts-style display-7">Specialization:</span>{{oneObj.special}}<br>
						<span class="text-danger mbr-fonts-style display-7"> Time Availability:</span>{{oneObj.time}}
						<span class="text-danger mbr-fonts-style display-7"> Consultation Fees:</span>{{oneObj.consultation}}</p>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        HOSPITAL/CLINIC NAME: {{oneRecord[0].hName}}<br>
        SPECIALIZATION: {{oneRecord[0].special}}<br>
        GENDER: {{oneRecord[0].gender}}<br>
        CONSULTATION FEES: {{oneRecord[0].consultation}}<br>
        TIME AVAILABITLITY: {{oneRecord[0].time}}<br>
        HOSPITAL/CLINIC CONTACT: {{oneRecord[0].contact}}<br>
        ...
        CERTIFICATES:<br>
     <center>   <img src="assets/images/{{oneRecord[0].picname1}}" width="250" height="250" class="card-img" alt="..."><br>
        <br>
         <img src="assets/images/{{oneRecord[0].picname2}}" width="250" height="250" class="card-img" alt="..."><br><br>
         <img src="assets/images/{{oneRecord[0].picname3}}" width="250" height="250" class="card-img-top" alt="..."> <br><br>        
        GALLERY:<br><br>
        <img src="assets/images/{{oneRecord[0].picname4}}" width="250" height="250" class="card-img-top" alt="...">
         <img src="assets/images/{{oneRecord[0].picname5}}" width="250" height="250" class="card-img-top" alt="...">
